...
{
    [Authorize(Roles = "Marker5, Admin")]
    public class Presenters5Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StudentName,SessionId,PaperTitle,PaperId,SelectedClarity,SelectedEyecon,SelectedInteng,SelectedTimekee,SelectedOrigqua,SelectedCorlev,SelectedWellstru,SelectedGooduse,SelectedQuestwell,SelectedClearansw,Totmar,Nominate,NMarked,Comments")] Presenter presenter)
        {
            ...
            presenter.SessionId = 5.ToString();
