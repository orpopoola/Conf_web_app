...
{
    [Authorize(Roles = "Marker7, Admin")]
    public class Presenters7Controller : Controller
    {
        ...
        // POST: Presenters2/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,StudentName,SessionId,PaperTitle,PaperId,SelectedClarity,SelectedEyecon,SelectedInteng,SelectedTimekee,SelectedOrigqua,SelectedCorlev,SelectedWellstru,SelectedGooduse,SelectedQuestwell,SelectedClearansw,Totmar,Nominate,NMarked,Comments")] Presenter presenter)
        {
            ...
            presenter.SessionId = 7.ToString();
        ...
        // POST: Presenters2/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StudentName,SessionId,PaperTitle,PaperId,SelectedClarity,SelectedEyecon,SelectedInteng,SelectedTimekee,SelectedOrigqua,SelectedCorlev,SelectedWellstru,SelectedGooduse,SelectedQuestwell,SelectedClearansw,Totmar,Nominate,NMarked,Comments")] Presenter presenter)
        {
            presenter.Totmar = (presenter.SelectedClarity + presenter.SelectedClearansw + presenter.SelectedCorlev + presenter.SelectedEyecon + presenter.SelectedGooduse + presenter.SelectedInteng + presenter.SelectedOrigqua + presenter.SelectedQuestwell + presenter.SelectedTimekee + presenter.SelectedWellstru).ToString();
            presenter.SessionId = 7.ToString();
            if (ModelState.IsValid)
